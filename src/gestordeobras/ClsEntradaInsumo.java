...
public class ClsEntradaInsumo {
   ...
   public boolean Salvar(){
        ...
        /*(ClsEndereco.ExisteID(Cod_Fun)!=true) 
            ...
            ConsultaSQL = "INSERT INTO entradainsumo (Quantidade, DataEntrada, Insumo_idInsumo) values ( ?, ?, ?)";
    ...
    public boolean Excluir(String Nome) {
            ...
            String ConsultaSQL = "DELETE from entradainsumo WHERE Nome = ?";
            try {
                PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
    ...
    public boolean AumentaQuantidadeInsumo(int CodInsumo, double Qtd) {
