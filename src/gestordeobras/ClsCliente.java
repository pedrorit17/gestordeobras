...
public class ClsCliente {
    ...
    public boolean Salvar(){
        ...
        String ConsultaSQL = "";
            ...
            ConsultaSQL = "INSERT INTO cliente (Endereco_idEndereco,Nome,CNPJ,Tipo,"
    ...
    public boolean Excluir(String Nome) {
            ...
            String ConsultaSQL = "DELETE from cliente WHERE Nome = ?";
            try {
                PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
    ...
    public boolean ExcluirObra(int Codigo) {
        
            Connection c = ConectaBD.getconexao();

            String ConsultaSQL = "DELETE from obra WHERE Cliente_idCliente = ?";
            try {
                PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
    ...
    public boolean Alterar(String Nome){
        ...
        String ConsultaSQL = "";
            ...
            ConsultaSQL = "UPDATE cliente SET Email = ?, Telefone = ?,"
                    + "Celular = ? WHERE Nome = ?";
    ...
    public boolean Pesquisar(String Nome){
        ...
        String ConsultaSQL = "";
        ConsultaSQL = "SELECT * FROM cliente WHERE Nome = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setString(1, Nome);
    ...
    /*public int PesquisaridRDOGrupo(int Codigo){
        Connection c = ConectaBD.getconexao();

        String ConsultaSQL = "";
        ConsultaSQL = "SELECT idRDOObra FROM rdoobragrupo WHERE obra_idobra = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setInt(1, Codigo);
            rs = Query1.executeQuery();
            if((rs.next())) {// se quisesse mais de uma colocar um while
                this.Codigo = rs.getInt("idRDOObra");
    ...
    public int PesquisaridRDOGeral(int Codigo){
        Connection c = ConectaBD.getconexao();

        String ConsultaSQL = "";
        ConsultaSQL = "SELECT idRDOObra FROM rdoobra WHERE obra_idobra = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setInt(1, Codigo);
    ...
    public int PesquisaridEndereco(String Nome){
        Connection c = ConectaBD.getconexao();

        String ConsultaSQL = "";
        ConsultaSQL = "SELECT Endereco_idEndereco FROM cliente WHERE Nome = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setString(1, Nome);
    ...
    public int PesquisaridObra(int Codigo){
        Connection c = ConectaBD.getconexao();

        String ConsultaSQL = "";
        ConsultaSQL = "SELECT idObra FROM obra WHERE Cliente_idCliente = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setInt(1, Codigo);
    ...
    public static boolean carregaTabela(JTable jTableFornecedor) {
        ...
        ConsultaSQL = "SELECT f.Nome, f.Telefone, f.Celular, f.Email"
                + ",e.Cidade, e.Estado FROM cliente f, endereco e WHERE f.Endereco_idEndereco = e.idEndereco "
    ...
    public static boolean carregaTabelaBusca(JTable jTableFornecedores, String nome) {
        ...
        String ConsultaSQL = "";
        ConsultaSQL = "SELECT f.Nome, f.Telefone, f.Celular, f.Email"
                + ",e.Cidade, e.Estado FROM cliente f, endereco e WHERE f.Endereco_idEndereco = e.idEndereco AND "
                + "f.Nome LIKE ? "
