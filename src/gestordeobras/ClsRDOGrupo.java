...
public class ClsRDOGrupo {
    ...
    public boolean Salvar(){
        ...
        /*(ClsEndereco.ExisteID(Cod_Fun)!=true) 
            ...
            ConsultaSQL = "INSERT INTO rdoobragrupo ( Clima, Responsavel, Data, "
    ...
    public int ExisteRDO(int CodObra){
        ...
        String ConsultaSQL = "";
        ConsultaSQL = "SELECT * FROM rdoobragrupo r, obra o WHERE r.obra_idobra = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
    ...
    public boolean ExcluirFuncionarios() {
    ...
    public boolean Alterar(int Codigo){
        ...
        String ConsultaSQL = "";
            ...
            ConsultaSQL = "UPDATE rdoobragrupo SET Clima = ?, AtvDesenvolvida = ?, Ocorrencia = ?"
                    + " WHERE idRDOObra = ?";
    ...
    public boolean carregaTabela(JTable jTableRDOGeral) {
        ...
        ConsultaSQL = "SELECT o.Nome, c.Nome, r.Responsavel, r.Data"
                + " FROM obra o, rdoobragrupo r, cliente c WHERE o.idobra = r.obra_idobra and c.idCliente = o.Cliente_idCliente "
    ...
    public int PesquisaidRdogeral(String Responsavel, String Obra, Date dataSql) {
        ...
        String ConsultaSQL = "";
        ConsultaSQL = "SELECT r.idRDOObra FROM rdoobragrupo r, obra o WHERE r.Responsavel = ? and o.Nome = ? and r.Data = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
    ...
    public boolean PesquisaClimaAtv(String Obra, String Responsavel, Date dataSql) {
        ...
        String ConsultaSQL = "";
        ConsultaSQL = "SELECT r.AtvDesenvolvida, r.Clima, r.Ocorrencia FROM rdoobragrupo r, obra o WHERE r.Responsavel = ? and o.Nome = ? and r.Data = ?";
        ResultSet rs;
        try {
            PreparedStatement Query1 = c.prepareStatement(ConsultaSQL);
            Query1.setString(1, Responsavel);
